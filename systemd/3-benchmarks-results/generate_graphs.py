...
plt.title('Rendiment Global del Sistema (Throughput d\'Imatges)', fontsize=16, pad=20, fontweight='bold')
plt.xlabel('Protocol de Comunicació (Edge-to-Edge)', fontsize=12, labelpad=15)
plt.ylabel('Rendiment Mitjà (imatges/segon)', fontsize=12, labelpad=15)
