...
Desafíos en el Edge (huella de memoria, latencia, ancho de banda). 
...
\section{Machine Learning Distribuido para Inferencia}
...
Conclusión de esta fase: La elección de ZeroMQ + MessagePack como pila de red ganadora para
integrar en Systemd.
...
Evaluación del incremento de estrés en CPU y memoria (Tproc ) al añadir el overhead matemático
de los tensores.
...
\begin{itemize}
    \item \textbf{Plano de Gestión (Reposo):} Consumo de RAM y CPU de Systemd+Podman inactivo frente al Kubelet+Kube-proxy+Etcd inactivos en el Edge. Comparativa del \textit{overhead} en reposo del Kubelet frente al demonio de Systemd.
    \item \textbf{Plano de Datos (Red):} Cuánta latencia extra añade el CNI de K8s a gRPC y ZeroMQ frente a la comunicación nativa P2P de Podman. Impacto del enrutamiento de Kube-proxy frente a la red nativa punto a punto.
